...
logger.info("Spacing intervals:")
logger.info(INTERVAL_LIST.values())
...
# Training
results_file = f"{RESULTS_DIR}/gmm32_class_results.h5"
        ...
        for osnr in gmm_utils.OSNR_LIST:
            for n in gmm_utils.N_CLASSES_LIST:
                ...
                if histograms_class_results[act_fn_name][neurons][osnr][n] == defaultdict():
                    ...
                    logger.info(f"Classes: {args.get('classes_n')}")
